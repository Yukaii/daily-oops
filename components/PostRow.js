...
export default function PostRow ({ post, index, totalCount }) {
  ...
  return <div className="Box-row Box-row--hover-gray d-flex flex-items-start">
    <div className='mr-2 mt-1 d-flex flex-items-start' style={{ color: 'var(--color-scale-red-2 )' }}>
      <NorthStarIcon />
    </div>
